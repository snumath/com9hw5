...
#bool mem_byte = imem_ifun == 0 || (imem_icode != IMRMOVQ && imem_icode != IRMMOVQ);
#bool mem_byte = M_ifun == 0 || (M_icode != IMRMOVQ && M_icode != IRMMOVQ);
#bool mem_byte = E_ifun == 0 || (E_icode != IMRMOVQ && E_icode != IRMMOVQ);
#bool mem_byte = f_ifun == 0 || (f_icode != IMRMOVQ && f_icode != IRMMOVQ);

bool mem_byte =
	#(imem_ifun == 0 || (imem_icode != IMRMOVQ && imem_icode != IRMMOVQ))
	 (M_ifun == 0 || (M_icode != IMRMOVQ && M_icode != IRMMOVQ))
	#&& (E_ifun == 0 || (E_icode != IMRMOVQ && E_icode != IRMMOVQ))
	#&& (f_ifun == 0 || (f_icode != IMRMOVQ && f_icode != IRMMOVQ))
	;
